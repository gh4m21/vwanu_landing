    ...
    <>
      <div className="">
        <form className="relative h-24 w-full">
          <input
            className="lg:[80%] w-full items-center rounded-full py-4 px-2 align-middle text-xl font-medium text-vwanu-secondary placeholder:text-xl hover:text-xl focus:text-xl active:text-xl lg:py-6 lg:pl-6"
            type="email"
            name="firstEmail"
            onChange={(e) => {
