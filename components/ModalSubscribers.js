    ...
    <>
      <div className="">
        <form className="relative h-24 w-full">
          <input
            className="lg:[80%] w-full items-center rounded-full py-4 px-2 align-middle text-xl font-medium text-blue-600 placeholder:text-xl hover:text-xl focus:text-xl active:text-xl lg:py-6 lg:pl-6"
            type="email"
            name="email"
            onChange={onChange}
          ...
          <button
            ...
            className="absolute top-[0.5rem] right-[0.5rem] z-10 w-1/3 items-center rounded-full bg-orange-600 py-2 text-lg text-white lg:py-4 lg:text-xl  "
          >
            Send Now!
          </button>
        </form>
            ...
            >
              <div className="inline-block transform overflow-hidden rounded-lg bg-white text-left align-bottom shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:align-middle">
                <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                  <div className="sm:flex sm:items-start">
                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                      ...
                      >
                        Fill the forms to be a Beta Tester
                      </Dialog.Title>
                      <div className="mt-2">
                ...
                <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                  <button
                    type="button"
                    className="inline-flex w-full justify-center rounded-full border border-transparent bg-orange-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 sm:ml-3 sm:w-auto sm:text-sm"
                    onClick={handleClick}
                  >
                    Send Email
                  </button>
